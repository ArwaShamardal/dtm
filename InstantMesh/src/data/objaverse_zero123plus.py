...
class ObjaverseData(Dataset):
    def __init__(self,
        ...
        # NOTE:: 1.2 added these two lines
        image_folder = self.root_dir / self.image_dir
        paths = [d.name for d in image_folder.iterdir() if d.is_dir()]
        ...
        if validation:
            ...
            self.paths = self.paths[-1:] # used last 1 as validation
        else:
            # NOTE:: swaped these
